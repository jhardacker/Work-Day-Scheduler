// Variables
var saveBtn = $(".saveBtn");
var currentHour = moment().format("HH"); //current hour 
...
$(document).ready(function () {
  ...
  for (var i = 0; i <= 12; i++) {  
      ...
      if (currentHourInt > inputHourInt) { // Gray for Past Hour
          $("#" + i + "Row").addClass("past");
      }
      if (currentHourInt < inputHourInt) { // Green for Future Hour 
